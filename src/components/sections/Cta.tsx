...
export default function CTA() {
  const stats = [
    ...
    { value: "24/7", label: "Technical Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of financial institutions and fintech companies who trust 
                OpenFlow for seamless banking integrations. Start building today.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Powering fintech innovation at leading financial institutions
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free API Access</h3>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Connect to 500+ banks with just a few lines of code
              </p>
            </div>
          </div>
        </div>
